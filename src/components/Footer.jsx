      ...
      <div className="  container mx-auto flex flex flex-col justify-center items-center md:flex-row ">
        <div className="  flex flex-col p-3 w-full max-sm:text-center max-sm:ms-0">
          <form onSubmit={handleSubmit}>
            ...
            <input type="submit" value={loading ?"Sending":"Send" } disabled={loading || !form.name.trim() ||!form.email.trim()} name="" className=' disabled:bg-gray-800 border max-sm:w-3/4 p-1 bg-blue-900  m-3 w-1/4 rounded-l hover:cursor-pointer hover:font-bold hover:bg-blue-400 ' />
          </form>
